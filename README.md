...
- [Changes in configuration files of Simple PFCP Client, TRex and UPFs](#changes)
  ...
  - [Changes in configuration files of UPFs](#changes_up)
    ...
    - [e. Changes in configuration files of OAI-CN5G-UPF](#changes_up_e)
- [Network settings of TRex and UPFs](#network_settings)
  ...
  - [e. Network settings of OAI-CN5G-UPF](#network_settings_up_e)
...
#### e. Changes in configuration files of OAI-CN5G-UPF
...
### e. Network settings of OAI-CN5G-UPF
...
<details><summary>e. logs for OAI-CN5G-UPF v2.2.0</summary>
